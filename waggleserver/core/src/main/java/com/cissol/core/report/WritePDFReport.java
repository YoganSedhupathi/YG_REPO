...
//				System.out.println(paramSkipValue+" "+v+" "+v1+" "+paramName+" "+paramCondition);
			...
			if (reportPDFOrient == 1) {
				if (reportPDFPage == 1) {
//		    		pdfWidth=PDPage.PAGE_SIZE_A4.getHeight();
//		    		pdfHeight=PDPage.PAGE_SIZE_A4.getWidth();
				} else if (reportPDFPage == 2) {
//		    		pdfWidth=PDPage.PAGE_SIZE_LETTER.getHeight();
//		    		pdfHeight=PDPage.PAGE_SIZE_LETTER.getWidth();
				} else {
//		    		pdfWidth=PDPage.PAGE_SIZE_A4.getHeight();
//		    		pdfHeight=PDPage.PAGE_SIZE_A4.getWidth();
				}
				...
				if (reportPDFPage == 1) {
//		    		pdfHeight=PDPage.PAGE_SIZE_A4.getHeight();
//		    		pdfWidth=PDPage.PAGE_SIZE_A4.getWidth();
				} else if (reportPDFPage == 2) {
//		    		pdfHeight=PDPage.PAGE_SIZE_LETTER.getHeight();
//		    		pdfWidth=PDPage.PAGE_SIZE_LETTER.getWidth();
				} else {
//		    		pdfHeight=PDPage.PAGE_SIZE_A4.getHeight();
//		    		pdfWidth=PDPage.PAGE_SIZE_A4.getWidth();
				}

 ...
 * Generated at: 2024-02-23 07:57:34 UTC
...
public final class physicalStockUpdate_jsp extends org.apache.jasper.runtime.HttpJspBase
...
String userId=(String)session.getAttribute("LOGIN_ID");
      ...
      out.write("              <h4 class=\"header-title\">Stock Update</h4>\r\n");
      out.write("            </div>\r\n");
      ...
      out.write("                </div>\r\n");
      out.write("                \r\n");
      out.write("                <div class=\"col-sm-3 col-md-3 col-lg-3\" style=\"display:block\" >                    \r\n");
      ...
      out.write("                       <div class=\"table-container\">\r\n");
      out.write("                           <div class=\"col-md-12 col-sm-12 garea\" id=\"stocks\"></div>\r\n");
      out.write("                           <div class=\"col-md-12 col-sm-12 garea\" id=\"group3\" style=\"display:none\"></div>\r\n");
      out.write("                      </div>\r\n");
      out.write("                </div>\r\n");
      ...
      out.write("                          <button type=\"button\" class=\"btn btn-clear\" onclick='add()'><span class=\"mdi mdi-refresh\"></span>Clear</button>\r\n");
      ...
      out.write("\r\n");
      out.write("\r\n");
      out.write("  var sProps={title:{height:25,width:100,name:\"Sales Return\"},initfocus:\"custtype\",container:{id:\"callback\",isdialog:false},js:\"js/validations/stockupdate.js\",screen:[\r\n");
      ...
      out.write("  {colno:0,name:\"tranno\",inputType:0,type:\"INT\",caption:\"Tran No\",mandatory:false,defaultValue:\"0\",\"maxValue\":0,\"textLength\":10,\"decimalLength\":0,\"visible\":false,\"readOnly\":true,\"chkTag\":false,nf:\"billdate\"},\r\n");
      out.write("  {colno:0,name:\"billdate\",inputType:0,type:\"DATE\",caption:\"Date\",format:\"dd/mm/yyyy\",defaultValue:\"\",\"chkTag\":false,visible:true,nf:\"stocks_data\"}\r\n");
      out.write("  ]},\r\n");
      ...
      out.write("  ]},\r\n");
      out.write("  {name:\"stocks\",title:\"Products\",height:30,width:98,minWidth:500,minHeight:250,colWidth:50,float:\"left\",backColor:\"biege\",contentType:\"Table\",tableProperties:{rowEmptyCheckColumn:1,columns:[\r\n");
      ...
      out.write("    {tgt:\"stocks_data\",tt:false,row:\"cr\",col:\"1\",id:\"0\"},\r\n");
      out.write("    {tgt:\"stocks_data\",tt:true,row:\"cr\",col:\"1\",id:\"1\"},\r\n");
      out.write("    {tgt:\"stocks_data\",tt:false,row:\"cr\",col:\"2\",id:\"2\"},\r\n");
      out.write("    {tgt:\"stocks_data\",tt:false,row:\"cr\",col:\"6\",id:\"8\"},\r\n");
      out.write("    {tgt:\"stocks_data\",tt:false,row:\"cr\",col:\"7\",id:\"10\"},\r\n");
      out.write("    {tgt:\"stocks_data\",tt:false,row:\"cr\",col:\"8\",id:\"12\"},\r\n");
      out.write("    {tgt:\"stocks_data\",tt:false,row:\"cr\",col:\"12\",id:\"12\"},\r\n");
      out.write("    {tgt:\"stocks_data\",tt:false,row:\"cr\",col:\"23\",id:\"13\"},\r\n");
      out.write("    {tgt:\"stocks_data\",tt:false,row:\"cr\",col:\"3\",id:\"17\"},\r\n");
      out.write("    {tgt:\"stocks_data\",tt:false,row:\"cr\",col:\"4\",id:\"18\"}\r\n");
      ...
      out.write("    {tgt:\"stocks_data\",tt:false,row:\"cr\",col:\"7\",id:\"0\"},\r\n");
      out.write("    {tgt:\"stocks_data\",tt:false,row:\"cr\",col:\"8\",id:\"1\"},\r\n");
      out.write("    {tgt:\"stocks_data\",tt:false,row:\"cr\",col:\"23\",id:\"2\"}\r\n");
      ...
      out.write("    {order:\"12\",id: \"unit\", name: \"Unit\", field: \"unit\",defaultValue:\"1\",\"inputType\":0,\"type\":\"TEXT\",\"maxValue\":0,\"textLength\":10,\"decimalLength\":0,\"visible\":false,\"readOnly\":true,\"mandatory\":false,width:0,chkTag:false},\r\n");
      out.write("    {order:\"13\",id: \"stock\", name: \"Stock\", field: \"stock\",defaultValue:\"0\",\"inputType\":0,\"type\":\"TEXT\",\"maxValue\":0,\"textLength\":10,\"decimalLength\":0,\"visible\":true,\"readOnly\":true,\"mandatory\":false,width:100,chkTag:false},\r\n");
      out.write("    {order:\"14\",id: \"mrp\", name: \"Mrp\", field: \"mrp\",defaultValue:\"0\",\"inputType\":0,\"type\":\"DECIMAL\",\"maxValue\":999999.99,\"textLength\":10,\"decimalLength\":2,\"visible\":false,\"readOnly\":false,\"mandatory\":false,width:100,align:\"right\"},    \r\n");
      out.write("    {order:\"15\",id: \"selling\", name: \"Selling\", field: \"selling\",defaultValue:\"0\",\"inputType\":0,\"type\":\"DECIMAL\",\"maxValue\":999999.99,\"textLength\":10,\"decimalLength\":2,\"visible\":true,\"readOnly\":true,\"mandatory\":true,width:100,align:\"right\"},\r\n");
      out.write("    {order:\"16\",id: \"nbatchno\", name: \"New BatchNo\", field: \"nbatchno\",defaultValue:\"\",\"inputType\":0,\"type\":\"TEXT\",\"maxValue\":0,\"textLength\":10,\"decimalLength\":0,\"visible\":showExpiry,\"readOnly\":false,\"mandatory\":showExpiry,width:ew,chkTag:false},\r\n");
      out.write("    {order:\"17\",id: \"nbatchdt\", name: \"New BatchDt\", field: \"nbatchdt\",defaultValue:\"NA\",\"inputType\":0,\"type\":\"TEXT\",\"maxValue\":0,\"textLength\":10,\"decimalLength\":0,\"visible\":false,\"readOnly\":true,\"mandatory\":false,width:0,chkTag:false},\r\n");
      out.write("    {order:\"18\",id: \"nexpdt\", name: \"New ExpDt\", field: \"nexpdt\",defaultValue:\"\",\"inputType\":0,\"type\":\"TDATE\",\"maxValue\":0,\"textLength\":10,\"decimalLength\":0,\"visible\":showExpiry,\"readOnly\":false,\"mandatory\":showExpiry,width:ew,chkTag:false,validation:\"checkdate\"},\r\n");
      out.write("    {order:\"19\",id: \"nqty\", name: \"Actual Qty\", field: \"nquantity\",defaultValue:\"0\",\"inputType\":0,\"type\":\"DECIMAL\",\"maxValue\":0,\"textLength\":10,\"decimalLength\":0,\"visible\":true,\"readOnly\":false,\"mandatory\":false,width:100,chkTag:false},            \r\n");
      out.write("    {order:\"20\",id: \"nmrp\", name: \"New Mrp\", field: \"nmrp\",defaultValue:\"0\",\"inputType\":0,\"type\":\"DECIMAL\",\"maxValue\":999999.99,\"textLength\":10,\"decimalLength\":2,\"visible\":true,\"readOnly\":false,\"mandatory\":true,width:100,align:\"right\"},    \r\n");
      out.write("    {order:\"21\",id: \"nselling\", name: \"New Selling\", field: \"nselling\",defaultValue:\"0\",\"inputType\":0,\"type\":\"DECIMAL\",\"maxValue\":999999.99,\"textLength\":10,\"decimalLength\":2,\"visible\":true,\"readOnly\":false,\"mandatory\":true,width:100,onchange:\"onRateQuantityChange\",align:\"right\"},\r\n");
      out.write("    {order:\"22\",id: \"csdid\", name: \"CsdId\", field: \"csdid\",defaultValue:\"0\",\"inputType\":0,\"type\":\"TEXT\",\"maxValue\":0,\"textLength\":10,\"decimalLength\":0,\"visible\":true,\"readOnly\":true,\"mandatory\":false,width:0,chkTag:false},\r\n");
      ...
      out.write("    ]}}]};\r\n");
      out.write("  //var screenProps=changeScreenAttributes(210008,sProps);\r\n");
      out.write("  var stockupdate=new FlexUI.Screen(\"stockupdate\",sProps);\r\n");
      out.write("  add('');\r\n");
      out.write("\r\n");
      out.write("\r\n");
      out.write("\r\n");

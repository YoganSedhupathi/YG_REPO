...
public final class conversionValue_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final jakarta.servlet.http.HttpServletRequest request, final jakarta.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("  <title>Conversion Master</title>\r\n");
      out.write("</head>\r\n");
      out.write("<body>\r\n");
      out.write("<div class=\"col-sm-10 col-md-10 col-lg-10 mpZero\"><h1>Conversion Master</h1><ol class=\"breadcrumb mpZero\"><li><a href=\"#\">Home</a></li><li><a>Master</a></li><li class=\"active breaCSel\"><strong>Conversion Master</strong></li></ol></div>\r\n");
      out.write("	\r\n");
      ...
      out.write("   <div class=\"clearfix\"></div>\r\n");
      out.write("   <div class=\"col-sm-12 col-md-12 col-lg-12 mTBx\">\r\n");
      out.write("    <div id=\"conversionvalue\" class=\"panelOrange hcH\" style=\"height:200px;\">\r\n");
      out.write("   </div></div>\r\n");
      out.write("</div>\r\n");
      ...
      out.write("  	{name:\"group1\",title:\"Unit Group Details\",pcolumns:2,height:40,width:98,minWidth:500,minHeight:200,colWidth:45,float:\"left\",backColor:\"beige\",contentType:\"Fields\",\r\n");
      ...
      out.write("  	{colno:0,name:\"name\",inputType:0,type:\"TEXT\",caption:\"Name\",mandatory:true,defaultValue:\"\",\"maxValue\":0,\"textLength\":100,\"decimalLength\":0,\"visible\":true,\"readOnly\":false,\"chkTag\":false,nf:\"baseunit\"},\r\n");
      out.write("  	{colno:1,name:\"baseunit\",inputType:0,type:\"LOV\",caption:\"Base Unit\",mandatory:true,defaultValue:\"\",\"maxValue\":0,\"textLength\":100,\"decimalLength\":0,\"visible\":true,\"readOnly\":false,\"chkTag\":true,nf:\"conversionvalue_data\",lovOptions:{url:\"/inventory/service/ajax\",ajax:\"unitmaster\",scrollEnabled:true,searchFromList:false,dsi:0,params:[],results:[]}}\r\n");
      out.write("  	]\r\n");
      out.write("  	},{name:\"conversionvalue\",title:\"Conversion Details\",height:30,width:98,minWidth:500,minHeight:200,colWidth:98,float:\"left\",backColor:\"biege\",contentType:\"Table\",tableProperties:{rowEmptyCheckColumn:1,optional:true,columns:[\r\n");
      ...
      out.write("    {order:\"1\",id: \"unit\", name: \"Unit\", field: \"location\",defaultValue:\"0\",\"inputType\":0,\"type\":\"LOV\",\"maxValue\":0,\"textLength\":10,\"decimalLength\":0,\"visible\":true,\"readOnly\":false,\"mandatory\":true,width:200,\"chkTag\":true,lovOptions:{url:\"/inventory/service/ajax\",ajax:\"unitmaster\",scrollEnabled:true,searchFromList:false,dsi:0,params:[],results:[]}},\r\n");
      out.write("    {order:\"2\",id: \"conversionvalue\", name: \"Conversion Value\", field: \"ptax\",defaultValue:\"0\",\"inputType\":0,\"type\":\"DECIMAL\",\"maxValue\":99999999.99999999,\"textLength\":17,\"decimalLength\":8,\"visible\":true,\"readOnly\":false,\"mandatory\":false,width:150}\r\n");
      out.write("    ]\r\n");
      out.write("    }}]};\r\n");
      out.write("  var screenProps=changeScreenAttributes(110011,sProps);\r\n");
      out.write("  var conversion=new FlexUI.Screen(\"conversionmaster\",screenProps);\r\n");
      out.write("  jqReport(110011,\"#xyz\");\r\n");
      out.write("  function addMasterData(){ \r\n");
      out.write("  	conversion.clearScreen(); \r\n");
      ...
      out.write("  	toggleSearchToolBar(\"110011\");\r\n");
      out.write("  }\r\n");
      ...
      out.write("    	conversion.setOperation(\"EDIT\");\r\n");
      out.write("    }\r\n");
      out.write("	var d=conversion.processDataToSave();\r\n");
      out.write("	if(\"FAILED\"!=d){\r\n");
      out.write("		var s=new FlexUI.Ajax();\r\n");
      out.write("		var r=s.callAjax(\"POST\",\"/inventory/service/unitconversion\",d);\r\n");
      out.write("		if(r.result==\"Success\"){\r\n");
      out.write("			setErrorMessage(r.message+\" [No:\"+r.code+\"]\");\r\n");
      out.write("			conversion.clearScreen();\r\n");
      out.write("			hideMasterData();\r\n");
      out.write("			reloadGrid(\"110011\");\r\n");
      ...
      out.write("  	if(url==\"\"){\r\n");
      out.write("  		url=\"/inventory/service/unitconversion\";\r\n");
      out.write("  	}\r\n");
      out.write("  	if(code!=\"\"){\r\n");
      out.write("  		code=\"code=\"+code+\"\";\r\n");
      out.write("  	}\r\n");
      out.write("	var v=l.callAjax(\"GET\",url,code);\r\n");
      out.write("	conversion.loadData(v);\r\n");
      out.write("	$('#callback').css('display','block');\r\n");
      out.write("  	$('#saveGrp').css('display','block');\r\n");
      out.write("  	$('#history').css('display','block');\r\n");
      out.write("  	$('#addGrp').css('display','none');\r\n");

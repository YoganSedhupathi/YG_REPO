...
public final class stockinward_jsp extends org.apache.jasper.runtime.HttpJspBase
...
String code=request.getParameter("code");
      ...
      out.write("	<div  class=\"subHe1\">Stock Inward<span class=\"pull-right right-btn\" onclick=\"showHideField('invoice')\"><b id=\"plusbutton1\" class=\"fa fa-angle-double-up\"></b></span>\r\n");
      out.write("	<div id=\"branch\" class=\"brTp\" style=\"display:block\">\r\n");
      out.write("   </div>\r\n");
      out.write("	<div class=\"col-sm-12 col-md-12 col-lg-12\" id=\"divHide\">\r\n");
      out.write("\r\n");
      ...
      out.write("\r\n");
      out.write("\r\n");
      out.write("  var sProps={title:{height:25,width:100,name:\"Invoice\"},container:{id:\"callback\",isdialog:false},js:\"js/validations/stockinward.js\",screen:[\r\n");
      ...
      out.write("  {colno:0,name:\"pf\",inputType:0,type:\"DECIMAL\",caption:\"P&F\",mandatory:false,defaultValue:\"0\",\"maxValue\":99999.99,\"textLength\":10,\"decimalLength\":2,\"visible\":true,\"readOnly\":false,\"chkTag\":false,nf:\"recdthro\",colspan:2,onchange:\"onTaxChange\"}\r\n");
      out.write("  \r\n");
      out.write("    \r\n");
      ...
      out.write("  {name:\"address1\",inputType:0,type:\"TEXT\",caption:\"Building\",mandatory:false,defaultValue:\"\",\"maxValue\":0,\"textLength\":100,\"decimalLength\":0,\"visible\":true,\"readOnly\":true,\"chkTag\":false,nf:\"address2\"},\r\n");
      out.write("  {name:\"address2\",inputType:0,type:\"TEXT\",caption:\"Street\",mandatory:false,defaultValue:\"\",\"maxValue\":0,\"textLength\":100,\"decimalLength\":0,\"visible\":true,\"readOnly\":true,\"chkTag\":false,nf:\"city\"},\r\n");
      out.write("  {name:\"city\",inputType:0,type:\"TEXT\",caption:\"City\",mandatory:false,defaultValue:\"\",\"maxValue\":0,\"textLength\":50,\"decimalLength\":0,\"visible\":true,\"readOnly\":true,\"chkTag\":false,nf:\"pincode\"},\r\n");
      out.write("  {name:\"pincode\",inputType:0,type:\"TEXT\",caption:\"PinCode\",mandatory:false,defaultValue:\"0\",\"maxValue\":0,\"textLength\":10,\"decimalLength\":0,\"visible\":true,\"readOnly\":true,\"chkTag\":false,nf:\"mobile\"},\r\n");
      out.write("  {name:\"mobile\",inputType:0,type:\"TEXT\",caption:\"Mobile\",mandatory:false,defaultValue:\"0\",\"maxValue\":0,\"textLength\":10,\"decimalLength\":0,\"visible\":true,\"readOnly\":true,\"chkTag\":false,nf:\"invno\"}*/\r\n");
      out.write("  ]},\r\n");
      ...
      out.write("  fields:[\r\n");
      out.write("  {colno:0,name:\"recdthro\",inputType:0,type:\"LOV\",caption:\"Transport\",mandatory:false,defaultValue:\"\",\"maxValue\":0,\"textLength\":10,\"decimalLength\":0,\"visible\":true,\"readOnly\":false,\"chkTag\":false,nf:\"lrno\",colspan:2,lovOptions:{url:\"/inventory/service/ajax\",ajax:\"transport\",scrollEnabled:true,searchFromList:false,dsi:0,params:[],results:[]}},\r\n");
      ...
      out.write("  {colno:0,name:\"lrdate\",inputType:0,type:\"DATE\",caption:\"LR Date\",format:\"dd/mm/yyyy\",defaultValue:\"\",\"chkTag\":false,visible:true,nf:\"invoice_data\"}\r\n");
      out.write("  ]\r\n");
      out.write("  },\r\n");
      ...
      out.write("  {colno:0,name:\"billdate\",inputType:0,type:\"DATE\",caption:\"Inward Date\",format:\"dd/mm/yyyy\",defaultValue:\"\",\"chkTag\":false,visible:true,nf:\"pf\"},\r\n");
      out.write("  {colno:1,name:\"go\",inputType:3,caption:\"Go\",onclick:\"calculateCashDiscount\",visible:true}\r\n");
      out.write("  \r\n");
      out.write("  ]\r\n");
      out.write("  },\r\n");
      ...
      out.write("  ]},\r\n");
      out.write("  {name:\"invoice\",title:\"Products\",height:30,width:98,minWidth:500,minHeight:250,colWidth:50,float:\"left\",backColor:\"biege\",contentType:\"Table\",tableProperties:{rowEmptyCheckColumn:1,readOnly:true,columns:[\r\n");
      ...
      out.write("    {order:\"12\",id: \"qty\", name: \"Qty\", field: \"quantity\",defaultValue:\"0\",\"inputType\":0,\"type\":\"DECIMAL\",\"maxValue\":0,\"textLength\":10,\"decimalLength\":0,\"visible\":true,\"readOnly\":true,\"mandatory\":true,width:100,onchange:\"\",cTotal:true,validation:\"\"},\r\n");
      ...
      out.write("    {order:\"18\",id: \"rate\", name: \"Rate\", field: \"rate\",defaultValue:\"0\",\"inputType\":0,\"type\":\"DECIMAL\",\"maxValue\":999999.99,\"textLength\":10,\"decimalLength\":2,\"visible\":true,\"readOnly\":true,\"mandatory\":true,width:100,onchange:\"\",align:\"right\"},\r\n");
      ...
      out.write("    {order:\"21\",id: \"discperc\", name: \"Disc%\", field: \"discperc\",defaultValue:\"0\",\"inputType\":0,\"type\":\"DECIMAL\",\"maxValue\":99.99,\"textLength\":10,\"decimalLength\":2,\"visible\":true,\"readOnly\":true,\"mandatory\":false,width:100,onchange:\"\",align:\"right\"},\r\n");
      ...
      out.write("	{order:\"23\",id: \"schemediscount\", name: \"Sch.Disc Amt\", field: \"schemediscount\",defaultValue:\"0\",\"inputType\":0,\"type\":\"DECIMAL\",\"maxValue\":999999.99,\"textLength\":10,\"decimalLength\":2,\"visible\":false,\"readOnly\":true,\"mandatory\":false,width:100,align:\"right\",onchange:\"onRateQuantityChange\"},\r\n");
      out.write("    {order:\"24\",id: \"cashdiscperc\", name: \"Cash Disc%\", field: \"cashdiscperc\",defaultValue:\"0\",\"inputType\":0,\"type\":\"DECIMAL\",\"maxValue\":999999.99,\"textLength\":10,\"decimalLength\":2,\"visible\":false,\"readOnly\":true,\"mandatory\":false,width:0,onchange:\"\",align:\"right\"},\r\n");
      out.write("	{order:\"25\",id: \"cashdiscamt\", name: \"Cash Disc Amount\", field: \"cashdiscamt\",defaultValue:\"0\",\"inputType\":0,\"type\":\"DECIMAL\",\"maxValue\":999999.99,\"textLength\":10,\"decimalLength\":2,\"visible\":false,\"readOnly\":true,\"mandatory\":false,width:0,align:\"right\"},	\r\n");
      out.write("    {order:\"26\",id: \"ptaxperc\", name: \"P.Tax%\", field: \"ptaxperc\",defaultValue:\"0\",\"inputType\":0,\"type\":\"DECIMAL\",\"maxValue\":999.99,\"textLength\":10,\"decimalLength\":2,\"visible\":true,\"readOnly\":true,\"mandatory\":false,width:100,onchange:\"\",align:\"right\"},\r\n");
      ...
      out.write("	{order:\"30\",id: \"staxperc\", name: \"S.Tax%\", field: \"staxperc\",defaultValue:\"0\",\"inputType\":0,\"type\":\"DECIMAL\",\"maxValue\":999999.99,\"textLength\":10,\"decimalLength\":2,\"visible\":true,\"readOnly\":true,\"mandatory\":false,width:100,align:\"right\"},\r\n");
      ...
      out.write("    {order:\"39\",id: \"isdid\", name: \"IsdId\", field: \"isdid\",defaultValue:\"0\",\"inputType\":0,\"type\":\"TEXT\",\"maxValue\":0,\"textLength\":10,\"decimalLength\":0,\"visible\":true,\"readOnly\":true,\"mandatory\":false,width:0,chkTag:false},\r\n");
      out.write("    {order:\"40\",id: \"barcode\", name: \"Barcode\", field: \"barcode\",defaultValue:\"0\",\"inputType\":0,\"type\":\"TEXT\",\"maxValue\":0,\"textLength\":20,\"decimalLength\":0,\"visible\":true,\"readOnly\":true,\"mandatory\":false,width:0,chkTag:false},\r\n");
      out.write("    {order:\"41\",id: \"obranch\", name: \"obranch\", field: \"obranch\",defaultValue:\"0\",\"inputType\":0,\"type\":\"TEXT\",\"maxValue\":0,\"textLength\":10,\"decimalLength\":0,\"visible\":true,\"readOnly\":true,\"mandatory\":false,width:0,chkTag:false},\r\n");
      out.write("    {order:\"42\",id: \"oisdid\", name: \"oisdid\", field: \"oisdid\",defaultValue:\"0\",\"inputType\":0,\"type\":\"TEXT\",\"maxValue\":0,\"textLength\":20,\"decimalLength\":0,\"visible\":true,\"readOnly\":true,\"mandatory\":false,width:0,chkTag:false},\r\n");
      out.write("    {order:\"43\",id: \"supplier\", name: \"Supplier\", field: \"supplier\",defaultValue:\"0\",\"inputType\":0,\"type\":\"TEXT\",\"maxValue\":0,\"textLength\":20,\"decimalLength\":0,\"visible\":true,\"readOnly\":true,\"mandatory\":false,width:0,chkTag:false},\r\n");
      out.write("    {order:\"44\",id: \"conversionvalue\", name: \"conversionvalue\", field: \"conversionvalue\",defaultValue:\"0\",\"inputType\":0,\"type\":\"DECIMAL\",\"maxValue\":0,\"textLength\":20,\"decimalLength\":10,\"visible\":false,\"readOnly\":true,\"mandatory\":false,width:0,chkTag:false},\r\n");
      out.write("    {order:\"45\",id: \"basequantity\", name: \"BaseQuantity\", field: \"basequantity\",defaultValue:\"0\",\"inputType\":0,\"type\":\"INT\",\"maxValue\":0,\"textLength\":10,\"decimalLength\":0,\"visible\":false,\"readOnly\":true,\"mandatory\":false,width:0,cTotal:true,chkTag:false},\r\n");
      out.write("    {order:\"46\",id: \"freight\", name: \"Freight\", field: \"freight\",defaultValue:\"0\",\"inputType\":0,\"type\":\"DECIMAL\",\"maxValue\":0,\"textLength\":10,\"decimalLength\":2,\"visible\":false,\"readOnly\":true,\"mandatory\":false,width:0,chkTag:false},\r\n");
      out.write("    {order:\"47\",id: \"netcost\", name: \"NetCost\", field: \"netcost\",defaultValue:\"0\",\"inputType\":0,\"type\":\"DECIMAL\",\"maxValue\":0,\"textLength\":10,\"decimalLength\":2,\"visible\":false,\"readOnly\":true,\"mandatory\":false,width:0,chkTag:false}\r\n");
      out.write("            \r\n");
      out.write("    ]}},\r\n");
      ...
      out.write("    ]}\r\n");
      out.write("    */\r\n");
      out.write("  var screenProps=changeScreenAttributes(410001,sProps);\r\n");
      out.write("  var stockinwardscreen=new FlexUI.Screen(\"xyz\",screenProps);\r\n");

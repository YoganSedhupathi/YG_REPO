...
<body>
			...
			<div class="card-body">
				<div class="row w-100 mb-3">
					<div class="col-md-6 d-flex align-items-center">
						<h4 class="header-title">Bills Query</h4>
					</div>
					<div  class="col-md-6 d-flex text-right" id="addGrp">
							<div class="col-md-7">
								<div class="input-group">
									...
									<span class="input-group-text">Cash/Corporate</span>
									<select class="form-control" id="cashcorp">
										<option value="2">Corporate</option>
										<option value="1">Cash</option>
									</select>
									<button type="button" class="btn btn-edit" onclick=reportGo(600001)">Go</button>
								</div>
							</div>
							<div class="col-md-5">
				...
				<div class="row lpage" id="jqcontainer" ><div class="table-container" ><div id="patientlist" class="w-100"></div></div></div>
				...
				<div class="col-md-12 col-sm-12 mpZero">
					...
					<div class="form-group mbotto">
						...
						<div class="col-md-8">
							...
							<input type="hidden" id="billdate" value=""/>
							...
							<input type="hidden" id="pclaimno" value="0"/>
	...
	var newParams="&fromdate="+$('#fromdate').val()+"&todate="+$('#todate').val()+"&cashcorp="+$('#cashcorp').val();
	...
	var sProps={js:"",screen:[
  	...
  	{name:"gender",inputType:1,type:"TEXT",caption:"",mandatory:false,defaultValue:"M","maxValue":0,"textLength":10,"decimalLength":0,"visible":true,"readOnly":false,"chkTag":false,nf:"sponsorname",values:"M~F",keys:"Male~Female"},
	{name:"sponsorcode",inputType:0,type:"INT",caption:"",mandatory:false,defaultValue:"0","maxValue":0,"textLength":10,"decimalLength":0,"visible":false,"readOnly":true,"chkTag":false,nf:"sponsorname"},
  	...
  	{name:"billsno",inputType:0,type:"INT",caption:"",mandatory:false,defaultValue:"0","maxValue":0,"textLength":10,"decimalLength":0,"visible":false,"readOnly":true,"chkTag":false,nf:""},
  	{name:"billno",inputType:0,type:"INT",caption:"",mandatory:false,defaultValue:"0","maxValue":0,"textLength":10,"decimalLength":0,"visible":false,"readOnly":true,"chkTag":false,nf:""},
  	{name:"billdate",inputType:0,type:"TEXT",caption:"",mandatory:false,defaultValue:"","maxValue":0,"textLength":10,"decimalLength":0,"visible":false,"readOnly":true,"chkTag":false,nf:""},
  	...
  	{name:"pclaimno",inputType:0,type:"INT",caption:"",mandatory:false,defaultValue:"0","maxValue":0,"textLength":10,"decimalLength":0,"visible":false,"readOnly":true,"chkTag":false,nf:""},
    ...
    function loadOrderData(url,name,did){
		...
		if(name=="Add"){
				if(rowData.claimno==0){
					showInsPatientDialog(rowData,"ADD");
				}else if(rowData.patienttype=="IP" && rowData.claimno!=0 && rowData.claimstatus==0){				
	 ...
	 function showInsPatientDialog(rowData,operation){
            ...
            screenObjects.getScreenObject("patientcode").setValue(rowData.patientcode);
  			...
  			screenObjects.getScreenObject("billno").setValue(rowData.billno);
  			screenObjects.getScreenObject("billsno").setValue(rowData.billsno);
  			screenObjects.getScreenObject("billdate").setValue(rowData.admissiondate);
  			screenObjects.getScreenObject("billamount").setValue(rowData.billamount);
	 ...
	 function savePatientList(){
        	...
        	if(claimno=="" || claimno=="0"){
    			...
    			inspatients.setOperation("DEL");
    		}
    		if(patientType=="IP"){
    			inspatients.setScreenCode(25);
    		}else{

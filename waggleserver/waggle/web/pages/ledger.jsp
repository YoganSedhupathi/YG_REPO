...
<script>
    ...
    var sProps={title:{height:30,width:100,name:"AMC"},container:{id:"callback",isdialog:false},js:"",screen:[
  	...
  	{colno:1,name:"branch",inputType:0,type:"LOV",caption:"Branch",mandatory:false,defaultValue:"0","maxValue":0,"textLength":10,"decimalLength":0,"visible":true,"readOnly":false,"chkTag":false,nf:"name",lovOptions:{url:"/waggle/service/ajax",ajax:"userbranch",scrollEnabled:true,searchFromList:false,dsi:0,params:[],results:[]}},
  	...
  	{colno:1,name:"group",inputType:0,type:"LOV",caption:"Type",mandatory:true,defaultValue:"0","maxValue":0,"textLength":10,"decimalLength":0,"visible":true,"readOnly":false,"chkTag":true,nf:"address1",lovOptions:{url:"/waggle/service/ajax",ajax:"accountgroups",scrollEnabled:true,searchFromList:false,dsi:0,params:[],results:[]}},
  	]
	...
	{colno:0,name:"opening",inputType:0,type:"NEGDEC",caption:"Opening Balance(-Dr/+Cr)",mandatory:false,defaultValue:"0","maxValue":999999999999.99,"textLength":30,"decimalLength":2,"visible":true,"readOnly":false,"chkTag":false,nf:"billwise"},

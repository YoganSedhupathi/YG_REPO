...
<body>
	...
	<div class="card border-0 shadow">
		<div class="card-body lpage" >
			...
			<div class="row " id="jqcontainer" ><div class="table-container" ><div id="xyz" class="w-100">
...
<script>
  	...
  	var defdata=l.callAjax("GET","/waggle/service/ajax","id=userbranch&ic=0");
    ...
    var sProps={title:{height:30,width:100,name:"AMC"},container:{id:"callback",isdialog:false},js:"",screen:[
  	...
  	{colno:1,name:"role",inputType:0,type:"LOV",caption:"Role",mandatory:true,defaultValue:"","maxValue":0,"textLength":100,"decimalLength":0,"visible":true,"readOnly":false,"chkTag":true,nf:"address1",lovOptions:{url:"/waggle/service/ajax",ajax:"roles",scrollEnabled:true,searchFromList:false,dsi:0,params:[],results:[]}}
  	]
	...
	{colno:0,name:"defbranch",inputType:0,type:"LOV",caption:"Primary Branch",mandatory:true,defaultValue:"0","maxValue":0,"textLength":10,"decimalLength":0,"visible":true,"readOnly":false,"chkTag":true,nf:"status",lovOptions:{url:"/waggle/service/ajax",ajax:"userbranch",scrollEnabled:true,searchFromList:false,dsi:0,params:[],results:[]}},
	...
	{colno:0,name:"usertype",inputType:0,type:"TEXT",caption:"Type",mandatory:false,defaultValue:"U","textLength":10,"visible":false,"readOnly":false,"chkTag":false,nf:"branch_data"}
  	...
  	},{name:"branch",title:"Employee Branch Details",height:30,width:98,minWidth:500,minHeight:200,colWidth:98,float:"left",backColor:"biege",contentType:"Table",tableProperties:{rowEmptyCheckColumn:"location",serialNumberColumn:"sno",rowObject:false,enableAddRow:false,optional:false,columns:[
  ...
  var employee=new FlexUI.Screen("employeemaster",sProps);
  jqReport(910002,"#xyz");

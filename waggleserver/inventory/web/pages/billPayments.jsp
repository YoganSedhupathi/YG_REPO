  ...
  <div class="card-body">
    ...
    <div class="row w-100">
      <div class="col-md-6 d-flex align-items-center">
        <h4 class="header-title">Bill Payments</h4>
      </div>
      ...
      <div id="callback">
        ...
        <div class="row w-100">
          <div class="col-sm-3 col-md-3 col-lg-3">                    
           ...
           <div class="col-sm-3 col-md-3 col-lg-3">                       
            <div id="paymentdetail" class="cBor">
            </div>
           </div>
            <div class="col-sm-6 col-md-6 col-lg-6 cBor" id="cashdetails">
     ...
     <div class="row w-100 mt-3">
          <div class="col-md-12">
            <div class="hstack justify-content-start">
              <div id="group2" style="display:block;"></div>
              <div  id="group7" ></div>
...
var defbranch=v.data;
  ...
  var sProps={title:{height:25,width:100,name:"Invoice"},container:{id:"callback",isdialog:false},js:"js/validations/billpayments.js",screen:[
  ...
  {colno:0,name:"trantype",inputType:0,type:"INT",caption:"Type",mandatory:false,defaultValue:"2","maxValue":0,"textLength":10,"decimalLength":0,"visible":false,"readOnly":true,"chkTag":false,nf:"branch"},
  ...
  {colno:1,name:"showcreditdays",inputType:4,type:"INT",caption:"Credit Days",mandatory:false,defaultValue:"0","maxValue":0,"textLength":10,"decimalLength":0,"visible":false,"readOnly":false,"chkTag":false,nf:"go"},
  ...
  fields:[
  {name:"dummy1",inputType:4,type:"TEXT",caption:"",keys:"Cash~Cheque",values:"C~Q",defaultValue:"C","readOnly":false,"chkTag":false,nf:"documents",visible:false},
  {name:"dummy2",inputType:4,type:"TEXT",caption:"",keys:"Cash~Cheque",values:"C~Q",defaultValue:"C","readOnly":false,"chkTag":false,nf:"documents",visible:false},
  ...
  {name:"go",inputType:3,caption:"Go",onclick:"loadSupplierOutstanding",visible:true}
  ]},
  ...
  fields:[
  {name:"trandate",inputType:0,type:"DATE",caption:"Payment Date",format:"dd/mm/yyyy",defaultValue:"","chkTag":false,visible:true,nf:"refno"},
  ...
  {name:"mode",inputType:1,type:"TEXT",caption:"Payment Mode",keys:"Cash~Cheque~Credit Card",values:"CA~CQ~CC",defaultValue:"CA","readOnly":false,"chkTag":false,nf:"account",visible:true,onchange:"onModeChange"}
  ]
  },
  ...
  {name:"outstanding",title:"",height:30,width:98,minWidth:500,minHeight:250,colWidth:50,float:"left",backColor:"biege",contentType:"Table",tableProperties:{rowEmptyCheckColumn:1,enableAddRow:false,enableDeleteRow:false,columns:[
    ...
    {order:"3",id: "amount", name: "Amount", field: "amount",defaultValue:"0","inputType":0,"type":"TEXT","maxValue":0,"textLength":10,"decimalLength":0,"visible":true,"readOnly":true,"mandatory":false,width:100,chkTag:false},
    {order:"4",id: "ppaid", name: "Adjusted", field: "ppaid",defaultValue:"0","inputType":0,"type":"TEXT","maxValue":0,"textLength":10,"decimalLength":0,"visible":true,"readOnly":true,"mandatory":false,width:100,chkTag:false},
    {order:"5",id: "balance", name: "Balance", field: "balance",defaultValue:"0","inputType":0,"type":"TEXT","maxValue":0,"textLength":10,"decimalLength":0,"visible":true,"readOnly":true,"mandatory":false,width:100,chkTag:false},
    ...
    {order:"7",id: "selected", name: "Pay", field: "selected",defaultValue:"0","inputType":2,"type":"TEXT","maxValue":0,"textLength":10,"decimalLength":0,"visible":true,"readOnly":false,"mandatory":false,width:20,chkTag:false,validation:"validateSelected"},    
    {order:"8",id: "paid", name: "Paid", field: "paid",defaultValue:"0","inputType":0,"type":"DECIMAL","maxValue":9999999.99,"textLength":10,"decimalLength":2,"visible":true,"readOnly":false,"mandatory":false,width:100,chkTag:false,onchange:"onPaidChange"},
  ...
  fields:[
  {colno:0,name:"discount",inputType:0,type:"DECIMAL",caption:"Discount",mandatory:false,defaultValue:"0","maxValue":0,"textLength":10,"decimalLength":2,"visible":true,"readOnly":false,"chkTag":false,nf:"charges",colspan:2,onchange:"onPaidChange"},
  {colno:1,name:"charges",inputType:0,type:"NEGDEC",caption:"Charges",mandatory:false,defaultValue:"0","maxValue":0,"textLength":10,"decimalLength":2,"visible":true,"readOnly":false,"chkTag":false,nf:"charges",colspan:2,onchange:"onPaidChange"},
  ...
  {name:"group6",title:"",height:20,width:45,minWidth:250,minHeight:50,colWidth:98,float:"right",backColor:"biege",contentType:"Fields",
  fields:[  
  ...
  var payments=new FlexUI.Screen("xyz",screenProps);
  setDefaultBranch();
  function loadSupplierOutstanding(rcode,rbranch){
  	var code=rcode;
  	var branch=rbranch;
  	if(code=="go"){
    ...
    if(code!='0' && code!="" && payments.getOperation()!="EDIT"){
    	showLoader();
	  	var	url="/inventory/service/supplier/outstanding";
  ...
  function goBack(){
        ...
        $("#currentMenuId").val(610004);
  }
  <%if(code!=null){%>
  	loadSupplierOutstanding('<%=code%>','<%=branch%>');
  <%}%>
 </script>
</body>
</html>

...
<head>
  ...
  <title>Location Stock Transfer</title>
</head>
<body>
...
<div id="callback"  >
	...
	<div  class="subHe1">Location Stock Transfer<span class="pull-right right-btn" onclick="showHideField('lout')"><b id="plusbutton1" class="fa fa-angle-double-up"></b></span>
   ...
   <div class="col-sm-12 col-md-12 col-lg-12 mpRes mTBx1">
    <div id="lout" class="panelOrange hcH" style="min-height:425px;" >
   </div></div>
...
if(showExpiry){
  ...
  var sProps={title:{height:25,width:100,name:"Invoice"},container:{id:"callback",isdialog:false},js:"js/validations/locationtransferout.js",screen:[
  ...
  {colno:0,name:"loutno",inputType:0,type:"INT",caption:"No",mandatory:false,defaultValue:"0","maxValue":0,"textLength":10,"decimalLength":0,"visible":false,"readOnly":true,"chkTag":false,nf:"transferdate"},
  {name:"transferdate",inputType:0,type:"DATE",caption:"Date",format:"dd/mm/yyyy",defaultValue:"","chkTag":false,visible:true,nf:"lout_data"},
  {name:"transfertype",inputType:1,type:"TEXT",caption:"Transfer Type",keys:"Normal",values:"N",defaultValue:"N","readOnly":false,"chkTag":false,nf:"sendthro",visible:false}
  ]
  },
  ...
  {name:"lout",title:"Products",height:30,width:98,minWidth:500,minHeight:250,colWidth:50,float:"left",backColor:"biege",contentType:"Table",tableProperties:{rowEmptyCheckColumn:1,columns:[
    ...
    {tgt:"lout_data",tt:false,row:"cr",col:"1",id:"0"},
    {tgt:"lout_data",tt:true,row:"cr",col:"1",id:"1"},
    {tgt:"lout_data",tt:false,row:"cr",col:"2",id:"2"},
    {tgt:"lout_data",tt:false,row:"cr",col:"29",id:"5"},
    {tgt:"lout_data",tt:false,row:"cr",col:"25",id:"6"},
    {tgt:"lout_data",tt:false,row:"cr",col:"33",id:"7"},
    {tgt:"lout_data",tt:false,row:"cr",col:"6",id:"8"},
    {tgt:"lout_data",tt:false,row:"cr",col:"7",id:"10"},
    {tgt:"lout_data",tt:false,row:"cr",col:"14",id:"10"},
    {tgt:"lout_data",tt:false,row:"cr",col:"8",id:"11"},
    {tgt:"lout_data",tt:false,row:"cr",col:"15",id:"11"},
    {tgt:"lout_data",tt:false,row:"cr",col:"43",id:"13"},
    {tgt:"lout_data",tt:false,row:"cr",col:"16",id:"14"}, 
    {tgt:"lout_data",tt:false,row:"cr",col:"45",id:"15"},
    {tgt:"lout_data",tt:false,row:"cr",col:"27",id:"16"},
    {tgt:"lout_data",tt:false,row:"cr",col:"3",id:"17"},
    {tgt:"lout_data",tt:false,row:"cr",col:"4",id:"18"}]},width:200,chkTag:true,validation:"getAttributeDetail"},
    ...
    {tgt:"lout_data",tt:false,row:"cr",col:"7",id:"0"},
    {tgt:"lout_data",tt:false,row:"cr",col:"8",id:"1"},
    {tgt:"lout_data",tt:false,row:"cr",col:"43",id:"2"},
    {tgt:"lout_data",tt:false,row:"cr",col:"14",id:"0"},
    {tgt:"lout_data",tt:false,row:"cr",col:"15",id:"1"}
    ...
    {order:"46",id: "netcost", name: "NetCost", field: "netcost",defaultValue:"0","inputType":0,"type":"DECIMAL","maxValue":0,"textLength":10,"decimalLength":0,"visible":false,"readOnly":false,"mandatory":false,width:0,chkTag:false}

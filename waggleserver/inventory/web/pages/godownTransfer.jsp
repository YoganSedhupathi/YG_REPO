...
<div id="callback"  >
	...
	<div  class="subHe1">Stock Allocation
	<span class="pull-right right-btn" onclick="showHideField('out')"><b id="plusbutton1" class="fa fa-angle-double-up"></b></span>
<div id="branch" class="brTp" style="display:block">
   ...
   <div class="col-sm-12 col-md-12 col-lg-12 mpRes mTBx1">
    <div id="out" class="panelOrange hcH" style="min-height:415px;" >
   </div></div>
...
if(showExpiry){
  ...
  var sProps={title:{height:25,width:100,name:"Invoice"},container:{id:"callback",isdialog:false},js:"js/validations/godowntransfer.js",screen:[
  ...
  {name:"frombranch",inputType:0,type:"LOV",caption:"Transfer To",mandatory:true,defaultValue:"0","maxValue":0,"textLength":10,"decimalLength":0,"visible":true,"readOnly":false,"chkTag":true,nf:"outwardno",lovOptions:{url:"/inventory/service/ajax",ajax:"godown",scrollEnabled:true,searchFromList:false,dsi:0,params:[],results:[]}},
  {name:"outwardno",inputType:0,type:"LOV",caption:"GIN No",mandatory:true,defaultValue:"0","maxValue":0,"textLength":10,"decimalLength":0,"visible":true,"readOnly":true,"chkTag":false,nf:"transferdate",lovOptions:{url:"/inventory/service/ajax",ajax:"grnfortransfer",scrollEnabled:true,searchFromList:false,dsi:2,params:[{n:"branch",src:"branch",ft:true},{n:"location",src:"location",ft:true}],results:[{tgt:"outwardsno",id:"0",tt:false},{tgt:"outwardno",id:"1",tt:false}]},validation:"getGinDetail"},
  {name:"outwardsno",inputType:0,type:"INT",caption:"GIN SNo",mandatory:false,defaultValue:"0","maxValue":0,"textLength":10,"decimalLength":0,"visible":false,"readOnly":true,"chkTag":false,nf:"billdate"},
  ]},
  ...
  fields:[
  {name:"billno",inputType:0,type:"INT",caption:"No",mandatory:false,defaultValue:"0","maxValue":0,"textLength":10,"decimalLength":0,"visible":false,"readOnly":true,"chkTag":false,nf:"billdate"},
  {name:"showbillno",inputType:4,type:"INT",caption:"No",mandatory:false,defaultValue:"0","maxValue":0,"textLength":10,"decimalLength":0,"visible":true,"readOnly":true,"chkTag":false,nf:"billdate"},
  {name:"transferdate",inputType:0,type:"DATE",caption:"Date",format:"dd/mm/yyyy",defaultValue:"","chkTag":false,visible:true,nf:"out_data"},
  ]},
  {name:"out",title:"Products",height:30,width:98,minWidth:500,minHeight:250,colWidth:50,float:"left",backColor:"biege",contentType:"Table",tableProperties:{rowEmptyCheckColumn:1,columns:[
    ...
    {order:"1",id: "product", name: "Product", field: "product",defaultValue:"0","inputType":0,"type":"LOV","maxValue":0,"textLength":10,"decimalLength":0,"visible":true,"readOnly":false,"mandatory":true,lovOptions:{url:"/inventory/service/ajax",ajax:"ginproducts",scrollEnabled:true,searchFromList:false,dsi:0,params:[{n:"billno",src:"outwardsno",ft:false}],results:[{tgt:"out_data",tt:false,row:"cr",col:"1",id:"0"},
    ...
    {tgt:"out_data",tt:false,row:"cr",col:"49",id:"10"}]},width:200,chkTag:true,validation:"getAttributeDetail"},
    ...
    {tgt:"out_data",tt:false,row:"cr",col:"15",id:"1"}]},width:80,chkTag:false,validation:""},
    ...
    {order:"45",id: "binname", name: "Bin", field: "binname",defaultValue:"0","inputType":0,"type":"LOV","maxValue":0,"textLength":10,"decimalLength":0,"visible":true,"readOnly":false,"mandatory":true,lovOptions:{url:"/inventory/service/ajax",ajax:"bin",scrollEnabled:true,searchFromList:false,dsi:0,params:[{n:"branch",src:"frombranch",ft:true}],results:[{tgt:"out_data",tt:false,row:"cr",col:"45",id:"0"},{tgt:"out_data",tt:true,row:"cr",col:"45",id:"1"}]},width:120,chkTag:true,validation:""},
    {order:"46",id: "rackname", name: "Rack", field: "rackname",defaultValue:"0","inputType":0,"type":"LOV","maxValue":0,"textLength":10,"decimalLength":0,"visible":true,"readOnly":false,"mandatory":true,lovOptions:{url:"/inventory/service/ajax",ajax:"racks",scrollEnabled:true,searchFromList:false,dsi:0,params:[{n:"bin",src:"out_data",row:"cr",col:"45",ft:true}],results:[{tgt:"out_data",tt:false,row:"cr",col:"46",id:"0"},{tgt:"out_data",tt:true,row:"cr",col:"46",id:"1"}]},width:120,chkTag:true,validation:""},
    {order:"47",id: "shelfname", name: "Shelf", field: "shelfname",defaultValue:"0","inputType":0,"type":"LOV","maxValue":0,"textLength":10,"decimalLength":0,"visible":true,"readOnly":false,"mandatory":true,lovOptions:{url:"/inventory/service/ajax",ajax:"shelf",scrollEnabled:true,searchFromList:false,dsi:0,params:[{n:"rackname",src:"out_data",row:"cr",col:"46",ft:true}],results:[{tgt:"out_data",tt:false,row:"cr",col:"47",id:"0"},{tgt:"out_data",tt:true,row:"cr",col:"47",id:"1"}]},width:120,chkTag:true,validation:""},
    {order:"48",id: "boxname", name: "Box", field: "boxname",defaultValue:"0","inputType":0,"type":"LOV","maxValue":0,"textLength":10,"decimalLength":0,"visible":true,"readOnly":false,"mandatory":true,lovOptions:{url:"/inventory/service/ajax",ajax:"box",scrollEnabled:true,searchFromList:false,dsi:0,params:[{n:"shelfname",src:"out_data",row:"cr",col:"47",ft:true}],results:[{tgt:"out_data",tt:false,row:"cr",col:"48",id:"0"},{tgt:"out_data",tt:true,row:"cr",col:"48",id:"1"}]},width:120,chkTag:true,validation:""},
    {order:"49",id: "allownegative", name: "AllowNegative", field: "allownegative",defaultValue:"0","inputType":0,"type":"INT","maxValue":0,"textLength":10,"decimalLength":0,"visible":false,"readOnly":false,"mandatory":false,width:0,chkTag:false}
    ]}},
  ...
  ,
    ...
    */
  var screenProps=changeScreenAttributes(410003,sProps);
  var godowntransferscreen=new FlexUI.Screen("xyz",screenProps);
  setDefaultBranch();

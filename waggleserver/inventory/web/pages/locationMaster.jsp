...
<body>
<div class="col-sm-10 col-md-10 col-lg-10 mpZero"><h1>Location</h1><ol class="breadcrumb mpZero"><li><a href="#">Home</a></li><li><a>Master</a></li><li class="active breaCSel"><strong>Location</strong></li></ol></div>
...
<script>
    ...
    var sProps={title:{height:30,width:100,name:"AMC"},container:{id:"callback",isdialog:false},js:"",screen:[
  	...
  	{colno:0,name:"branch",inputType:0,type:"LOV",caption:"Branch",mandatory:true,defaultValue:"0","maxValue":0,"textLength":10,"decimalLength":0,"visible":true,"readOnly":false,"chkTag":true,nf:"lmname",lovOptions:{url:"/inventory/service/ajax",ajax:"userbranch",scrollEnabled:true,searchFromList:false,dsi:0,params:[],results:[]}},
  	{colno:0,name:"lmname",inputType:0,type:"TEXT",caption:"Name",mandatory:true,defaultValue:"","maxValue":0,"textLength":50,"decimalLength":0,"visible":true,"readOnly":false,"chkTag":false,nf:"status"},
  	{colno:0,name:"lmdefault",inputType:1,type:"TEXT",caption:"Is Default Location",mandatory:true,defaultValue:"","textLength":10,"visible":true,"readOnly":false,"chkTag":false,nf:"status",keys:"No~Yes",values:"0~1"},
  ...
  var screenProps=changeScreenAttributes(110018,sProps);
  ...
  function onSaveClicked(id,me){
	...
	if("FAILED"!=d){
		...
		showLoader();
		var r=s.callAjax("POST","/inventory/service/branch/location",d);
		hideLoader();
		if(r.result=="Success"){
  ...
  function loadOrderData(url,code,did){
  	if(url==""){
  		url="/inventory/service/branch/location";
  	}
  	if(code!=""){
  		code="code="+code+"";
  	}
	...
	$('#callback').css('display','block');
  	...
  	$('#xyz').css('display','none');
  	hideLoader();
  	screenObjects.getScreenObject("lmname").focus();
  }
</script> 
</body>
</html>
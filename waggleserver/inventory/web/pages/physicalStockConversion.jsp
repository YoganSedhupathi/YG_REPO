...
<div id="callback"  >
   ...
   <div class="col-sm-12 col-md-12 col-lg-12 mpRes mTBx1">
    <div id="conv" class="panelOrange hcH" style="min-height:425px;" >
   </div></div>
...
if(showExpiry){
  ...
  var sProps={title:{height:25,width:100,name:"Invoice"},container:{id:"callback",isdialog:false},js:"js/validations/physicalconversion.js",screen:[
  ...
  fields:[{name:"code",inputType:0,type:"INT",caption:"Code",mandatory:false,defaultValue:"0","maxValue":0,"textLength":10,"decimalLength":0,"visible":false,"readOnly":true,"chkTag":false,nf:"conversiondate"},
  {name:"conversiondate",inputType:0,type:"DATE",caption:"Date",format:"dd/mm/yyyy",defaultValue:"","chkTag":false,visible:true,nf:"conv_data"},
  {name:"showoutno",inputType:4,type:"INT",caption:"No",mandatory:false,defaultValue:"0","maxValue":0,"textLength":10,"decimalLength":0,"visible":true,"readOnly":true,"chkTag":false,nf:"conv_data"},
  {name:"soutno",inputType:0,type:"INT",caption:"No",mandatory:false,defaultValue:"0","maxValue":0,"textLength":10,"decimalLength":0,"visible":false,"readOnly":true,"chkTag":false,nf:"conv_data"}  
  ]},
  ...
  {name:"conv",title:"Products",height:30,width:98,minWidth:500,minHeight:250,colWidth:50,float:"left",backColor:"biege",contentType:"Table",tableProperties:{rowEmptyCheckColumn:1,columns:[
    ...
    {tgt:"conv_data",tt:false,row:"cr",col:"1",id:"0"},
    {tgt:"conv_data",tt:true,row:"cr",col:"1",id:"1"},
    {tgt:"conv_data",tt:false,row:"cr",col:"2",id:"2"},
    {tgt:"conv_data",tt:false,row:"cr",col:"6",id:"8"},
    {tgt:"conv_data",tt:false,row:"cr",col:"8",id:"9"},
    {tgt:"conv_data",tt:false,row:"cr",col:"7",id:"10"},
    {tgt:"conv_data",tt:false,row:"cr",col:"39",id:"11"},
    {tgt:"conv_data",tt:false,row:"cr",col:"13",id:"12"},
    {tgt:"conv_data",tt:false,row:"cr",col:"3",id:"15"},
    {tgt:"conv_data",tt:false,row:"cr",col:"4",id:"16"}]},width:200,chkTag:true,validation:"getAttributeDetail"},
    ...
    {tgt:"conv_data",tt:false,row:"cr",col:"7",id:"0"},
    {tgt:"conv_data",tt:false,row:"cr",col:"8",id:"1"},
    {tgt:"conv_data",tt:false,row:"cr",col:"39",id:"2"}
    ...
    {tgt:"conv_data",tt:true,row:"cr",col:"16",id:"1"},
    ...
    {tgt:"conv_data",tt:false,row:"cr",col:"45",id:"2"}
    ]},width:80,chkTag:false,validation:""},
  ...
  var toscreen=new FlexUI.Screen("xyz",sProps);
  setDefaultBranch();
